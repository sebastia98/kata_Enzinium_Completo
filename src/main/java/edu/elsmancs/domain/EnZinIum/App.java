...
import edu.elsmancs.domain.EnZinIum.TokenContract;
...
public class App {
    ...
    public static void main( String[] args )
    {
        ...
        ricknillos.addOwner(rick.getPK(), 500);
        ...
        ricknillos.transfer(morty.getPK(), 2);
        ...
        ricknillos.transfer(morty.getPK(), 300);
